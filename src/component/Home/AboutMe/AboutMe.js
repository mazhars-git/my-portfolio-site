        ...
        <section id="about" className="container py-4">
            ...
            <div className="row">
                ...
                <div className="col-md-6 align-self-center pl-5">
                    ...
                    <p className="pb-3 fst-normal lh-base">I am a professional web developer. I have completed more then 15+ projects on programming sector. I am good at JavaScript, React and React Native. I can design and develop any kind of web site with responsive.</p>
