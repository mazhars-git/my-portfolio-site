    ...
    <section className="container">
      <div className="row header-content">
        <div className="col-md-6 align-self-center pt-3">
          <h3 className="pb-3" style={{ color: "tomato" }}>
            Hi! I AM MAZHAR
          </h3>
          <Typical
            steps={[
          ...
          <div className="social-icon pt-4">
            <ul>
              <li>
                {" "}
                <a target="_blank" href="https://github.com/mazhars-git">
              ...
              <li>
                ...
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/md-mazharul-islam-15b31618a/"
                >
              ...
              <li>
                ...
                <a
                  target="_blank"
                  href="https://www.facebook.com/noman.abdullah.71619/"
                >
              ...
              <li>
                {" "}
                <a target="_blank" href="https://www.instagram.com/mazhar.in/">
